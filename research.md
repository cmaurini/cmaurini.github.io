...
to fracture. My interests focus on the links between gradient-damage models and brittle fracture, and on the use of damage models as phase-field models of fracture.
...
I also work on numerical developments to improve the efficiency of available HPC techniques for phase-field fracture models. I distribute several open-source codes to reproduce the results of my papers and, hopefully, to serve as examples for others.
...
In a series of works, we studied the multistability of shells and its dependence on material properties, initial shape, and prestress. We showed how active materials (piezoelectric actuators) can be effectively used to control their shape.
...
During my Ph.D., I studied passive vibration control of mechanical structures through distributed piezoelectric transducers and resonant electrical networks. In contemporary terminology, we designed, fabricated, and tested electromechanical metamaterials for dissipating mechanical vibrations in electrical circuits. These ideas have recently received renewed interest.
